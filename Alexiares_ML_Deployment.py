...
- Scan a directory for all files contained
- Make a csv file with all files in a directory
- Model after trained on similar dataset with labels
- Model will predict file, malware/clean 
- if mal is detected add to an array 
- loop through list and ask the user if they want to keep file or os.remove


Functions =  camelCase
Variables = cabab_case
'''
...
# import sys was used for entropy?
...
'''
File Extension (HEX) (did not use)
'''
...
File Entropy
'''
# # this calculates the entropy of a file was abel to confirm with pestudio
